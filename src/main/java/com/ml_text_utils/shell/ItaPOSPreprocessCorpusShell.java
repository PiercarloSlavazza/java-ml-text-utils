...
interface ItaPOSPreprocessCorpusShellConfig {
...
public class ItaPOSPreprocessCorpusShell {

    private final static Logger log = LoggerFactory.getLogger(PreprocessFileShell.class);

    public static void main(String[] args) {

	ItaPOSPreprocessCorpusShellConfig config = CliFactory.parseArguments(ItaPOSPreprocessCorpusShellConfig.class, args);
