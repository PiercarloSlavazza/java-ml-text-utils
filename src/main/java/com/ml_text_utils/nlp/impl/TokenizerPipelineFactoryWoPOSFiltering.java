...
public class TokenizerPipelineFactoryWoPOSFiltering implements TokenizerFactory {

    private final OpenNLPTokenizerFactory openNLPTokenizerFactory;
    private final SnowballStemmerFactory snowballStemmerFactory;

    public TokenizerPipelineFactoryWoPOSFiltering(OpenNLPTokenizerFactory openNLPTokenizerFactory,
						  SnowballStemmerFactory snowballStemmerFactory) {
